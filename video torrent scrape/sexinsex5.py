...
for id in range(1,500):
    ...
    # 230 亚洲成人有码原创区
    # 229 欧美成人无码原创区
    response = requests.get(f'http://www.sexinsex.net/bbs/forum-25-{id}.html', headers = headers)
    print(response)
        ...
        for th in ths:
            ...
            try:
                ...
                if  title.__contains__(""):
                    ...
                    torrent_file = TorrentDownloader(f"D:/Media/torrent/{attachment_name}", f'D:/Media/asian/')
